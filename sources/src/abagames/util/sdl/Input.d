 ...
 private:
  ...
  public int getButtonState() {
    ...
    version (PANDORA_OR_PYRA) {
      ...
      if (keys[SDL_SCANCODE_Z] == SDL_PRESSED || keys[SDL_SCANCODE_LCTRL] == SDL_PRESSED || btn1 || btn4) btnz = true;
      if (keys[SDL_SCANCODE_X] == SDL_PRESSED || keys[SDL_SCANCODE_LALT] == SDL_PRESSED || btn2 || btn3) btnx = true;
    }
    if (btnz) {
      if (!buttonReversed)
	btn |= PAD_BUTTON1;
